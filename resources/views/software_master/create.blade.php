                ...
                <div class="grid md:grid-cols-2 gap-6 mt-6">
                    ...
                    <div>
                        ...
                        <select
                            name="Status"
                            required
                            class="w-full rounded-xl border-slate-300 focus:ring-blue-500 focus:border-blue-500 @error('Status') border-red-500 @enderror">
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <ul class="mt-3 text-sm text-blue-700 space-y-2 list-disc list-inside">
                                ...
                                <li>Setelah Software dibuat, seluruh Detail Licensing akan menggunakan Licensing ID ini.</li>
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <h3 class="font-semibold text-blue-800">
                            ...
                            Setelah Software Master disimpan

                        </h3>

                        <p class="text-sm text-blue-700 mt-2 leading-relaxed">

                            Setelah Software Master berhasil dibuat, Anda akan diarahkan kembali
                            ke halaman Master Software.

                            <br><br>

                            Untuk menambahkan Detail Licensing, cukup klik tombol
                            <strong>Tambah Detail</strong> pada Software tersebut.

                            Dengan cara ini setiap Detail Licensing akan otomatis terhubung
                            ke Licensing ID yang benar sehingga tidak perlu memilih Licensing ID
                            secara manual lagi.
