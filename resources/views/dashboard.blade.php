...
<div class="max-w-7xl mx-auto px-8 py-8">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <a href="{{ route('software-master.index') }}">
            ...
            <div class="group bg-white rounded-2xl shadow-lg hover:shadow-2xl transition duration-300 p-8 border hover:border-blue-500">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <div>
                        ...
                        <p class="text-slate-500 mt-3">
                            ...
                            Mengelola seluruh data software yang dimiliki perusahaan, vendor, status lisensi, serta masa berlaku.

                        </p>

                    </div>

                    <div class="w-20 h-20 rounded-2xl bg-blue-100 flex items-center justify-center group-hover:scale-110 transition">
        ...
        <a href="{{ route('software-detail.index') }}">
            ...
            <div class="group bg-white rounded-2xl shadow-lg hover:shadow-2xl transition duration-300 p-8 border hover:border-green-500">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <div class="w-20 h-20 rounded-2xl bg-green-100 flex items-center justify-center group-hover:scale-110 transition">
