...
<div class="min-h-screen bg-slate-100">
            ...
            <div class="flex flex-col md:flex-row justify-between items-center gap-6">
                ...
                <div class="flex items-center gap-4 text-white">
                    ...
                    <div class="w-16 h-16 rounded-2xl bg-white/20 backdrop-blur flex items-center justify-center">
                        ...
                        <i class="bi bi-building-fill-add text-4xl"></i>
                    ...
                    <div>
                        ...
                        <p class="text-purple-100 mt-1">
                            Tambahkan data Organization baru ke dalam sistem.
                        </p>
    ...
    <div class="max-w-5xl mx-auto px-6 py-8">
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-slate-100 overflow-hidden">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-slate-500">
                            Lengkapi informasi Organization yang akan ditambahkan.
                        </p>
            ...
            <form action="{{ route('organizations.store') }}" method="POST" class="p-8">
                    ...
                    <div class="flex gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-purple-700 mt-1">
                                Pastikan nama Organization yang dimasukkan belum pernah terdaftar agar tidak terjadi duplikasi data.
                            </p>
